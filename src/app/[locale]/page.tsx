...
export default async function HomePage() {
    ...
    <div className="portal-main-grid">
      ...
      <aside className="portal-sidebar"><section id="modelos" className="portal-ranking-section"><SectionTitle title={t("models")} href="/modelos" link={t("compare")}/><ModelLeaderboard boards={boards} compact/></section><Link className="portal-academy-link" href="/modulos"><BookOpen size={23} aria-hidden="true"/><div><h3>{t("academyTitle")}</h3><p>{t("academyDescription")}</p></div><ArrowUpRight size={20} aria-hidden="true"/></Link><Link className="portal-academy-link" href="/skills"><Puzzle size={23} aria-hidden="true"/><div><h3>{skills("homeTitle")}</h3><p>{skills("homeDescription")}</p></div><ArrowUpRight size={20} aria-hidden="true"/></Link></aside>
    </div>
